NOTE: DEPRECATED! The composed-edit1-edit2.patch file here is for the old algorithm, 
which is way too complex and impossible to use with no data (converts 'sequence' items 
in the line map into hunks, therefore needs lines of the src and dest *file* 
-- a good algorithm should not need any data besides the changelogs themselves). 
